...
import controller from '../../controllers/admin/bankLoanCommissions';
 ...
 */
// #endregion
router.post('/getBankLoanCommission', controller.getBankLoanCommission);
 ...
 */
// #endregion
router.post('/insertUpdateBankLoanCommission', controller.insertUpdateBankLoanCommission);
