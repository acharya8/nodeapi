...
import controller from '../../controllers/admin/creditCard';
 ...
 */
// #endregion
router.post('/getCreditCard', controller.getCreditCard);
 ...
 */
// #endregion
router.post('/getCreditCardById', controller.getCreditCardById);
 ...
 */
// #endregion
router.post('/insertUpdateCreditCard', controller.insertUpdateCreditCard);
 ...
 */
// #endregion
router.post('/changeCreditCardOfferStatus', controller.changeCreditCardOfferStatus);
 ...
 */
// #endregion
router.post('/inserUpdaterejectCreditCardOffer', controller.inserUpdaterejectCreditCardOffer);
 ...
 */
// #endregion
router.post('/getCreditCardStatuses', controller.getCreditCardStatuses);
