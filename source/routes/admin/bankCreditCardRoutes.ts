...
import controller from '../../controllers/admin/bankCreditCard';
 ...
 */
// #endregion
router.post('/insertUpdateBankCreditCard', controller.insertUpdateBankCreditCard);
 ...
 */
// #endregion
router.post('/getBankCreditCard', controller.getBankCreditCard);
