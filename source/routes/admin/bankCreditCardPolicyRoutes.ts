...
import controller from '../../controllers/admin/bankCreditCardPolicy';
 ...
 */
// #endregion
router.post('/insertUpdateBankCreditCardPolicy', controller.insertUpdateBankCreditCardPolicy);
 ...
 */
// #endregion
router.post('/getBankCreditCardPolicy', controller.getBankCreditCardPolicy);
 ...
 */
// #endregion
router.post('/getCompanyCategoryType', controller.getCompanyCategoryType);
