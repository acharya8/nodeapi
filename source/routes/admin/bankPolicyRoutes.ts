...
import controller from '../../controllers/admin/bankPolicies';
 ...
 */
// #endregion
router.post('/insertUpdateBankPolicy', controller.insertUpdateBankPolicy);
 ...
 */
// #endregion
router.post('/getBankPolicy', controller.getBankPolicy);
