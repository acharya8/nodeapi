...
import controller from '../../controllers/admin/businessAnnualProfits';
 ...
 */
// #endregion
router.post('/getBusinessAnnualProfits', controller.getBusinessAnnualProfits);
...
router.post('/insertBusinessAnnualProfit', controller.insertBusinessAnnualProfit);
 ...
 */
// #endregion
router.post('/updateBusinessAnnualProfit', controller.updateBusinessAnnualProfit);
 ...
 */
// #endregion
router.post('/activeInactiveBusinessAnnualProfit', controller.activeInActiveBusinessAnnualProfit);
