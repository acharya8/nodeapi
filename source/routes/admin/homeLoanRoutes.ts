...
import controller from '../../controllers/admin/homeLoan';
 ...
 */
// #endregion
router.post('/getHomeLoan', controller.getHomeLoan);
 ...
 */
// #endregion
router.post('/getHomeLoanById', controller.getHomeLoanById);
 ...
 */
// #endregion
router.post('/insertUpdateHomeLoanBasicDetail', controller.insertUpdateHomeLoanBasicDetail);
 ...
 */
// #endregion
router.post('/insertUpdateHomeLoanPropertyDetail', controller.insertUpdateHomeLoanPropertyDetail);
 ...
 */
// #endregion
router.post('/insertUpdateHomeLoanCustomerEmploymentDetail', controller.insertUpdateHomeLoanEmploymentDetail);
