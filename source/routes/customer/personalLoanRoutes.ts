...
import controller from '../../controllers/customer/personalLoan';
 ...
 */
// #endregion
router.post('/insertUpdateEmploymentDetail', controller.insertUpdateEmploymentDetail);
 ...
 */
// #endregion
router.post('/insertUpdateMoreBasicDetail', controller.insertUpdateMoreBasicDetail);
 ...
 */
// #endregion
router.post('/updateMoreEmploymentDetail', controller.updateMoreEmploymentDetail);
 ...
 */
// #endregion
router.post('/getIncompletePersonalLoanDetail', controller.getIncompletePersonalLoanDetail);
 ...
 */
// #endregion
router.post('/getCustomerPersonalById', controller.getCustomerPersonalById);
 ...
 */
// #endregion
router.post('/acceptLoanOffer', controller.customerAcceptOffer);
 ...
 */
// #endregion
router.post('/getGeneratedOffer', controller.getOffer);
 ...
 */
// #endregion
router.post('/checkEligibility', controller.checkEligibility);
 ...
 */
// #endregion
router.post('/getLoanRejectionReason', controller.getCustomerLoanRejectionReason);
 ...
 */
// #endregion
router.post('/getLoanDetail', controller.getCustomerLoanDetail);
 ...
 */
// #endregion
router.post('/changeEmploymentType', controller.changeEmploymentType);
 ...
 */
// #endregion
router.post('/newToTransfer', controller.newToTransfer);
export = router;