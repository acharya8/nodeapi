...
import controller from '../../controllers/customer/users';
 ...
 */
// #endregion
router.post('/clientVerifyContact', controller.clientVerifyContact);
 ...
 */
// #endregion
router.post('/updateCustomerDetail', controller.updateCustomerDetail);
 ...
 */
// #endregion
router.post('/updateCustomerProfile', controller.updateCustomerProfile);
 ...
 */
// #endregion
router.post('/insertRequestForBecomePartner', controller.insertRequestForBecomePartner);
 ...
 */
// #endregion
router.post('/checkStatusForBecomeapartner', controller.checkStatusForBecomeapartner);
