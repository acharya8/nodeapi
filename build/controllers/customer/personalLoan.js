...
const insertUpdateEmploymentDetail = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
            ...
            if (authorizationResult.statusCode == 200) {
                ...
                if (result) {
                    ...
                    if (result.length && result[0].length > 0) {
                        let successResult = new resultsuccess_1.ResultSuccess(200, true, 'Employment Detail Saved', result[0], 1);
                        console.log(successResult);
                        return res.status(200).send(successResult);
                    }
                    else {
                        let successResult = new resultsuccess_1.ResultSuccess(200, true, 'Employment Detail Saved', result, 1);
                        console.log(successResult);
                        return res.status(200).send(successResult);
                    }
                }
                else {
                    let errorResult = new resulterror_1.ResultError(400, true, "Employment Detail Not Saved", result, '');
                    next(errorResult);
                }
            }
            else {
        ...
        let errorResult = new resulterror_1.ResultError(500, true, 'personalLoan.insertUpdateEmploymentDetail()', error, '');
        next(errorResult);
    }
});
...
const insertUpdateMoreBasicDetail = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        if (validationResult && validationResult.statusCode == 200) {
            ...
            if (authorizationResult.statusCode == 200) {
                ...
                if (result) {
                    console.log(result);
                    let successResult = new resultsuccess_1.ResultSuccess(200, true, 'Personal Loan Basic Detail Updated', [result[0][0], result[1][0]], 1);
                    console.log(successResult);
                    return res.status(200).send(successResult);
                }
                else {
                    let errorResult = new resulterror_1.ResultError(400, true, "Personal Loan Basic Detail Not Updated", result, '');
                    next(errorResult);
                }
            }
            else {
        ...
        let errorResult = new resulterror_1.ResultError(500, true, 'personalLoan.insertUpdateMoreBasicDetail()', error, '');
        next(errorResult);
    }
});
            ...
            if (authorizationResult.statusCode == 200) {
                ...
                if (result && result.length > 0 && result[0].length > 0) {
                    if (result[0][0].message && result[0][0].message == "Data Not Available") {
                        ...
                        let basicDetail = new customerResponse_1.CustomerResponse(obj[0].fullName, obj[0].birthdate, obj[0].panCardNo, obj[0].customerLoan.employmentTypeId, obj[0].customerLoanEmploymentDetail.monthlyIncome, obj[0].customerLoanEmploymentDetail.companyName, obj[0].customerLoanEmploymentDetail.officePincode, obj[0].customerLoan.loanAmount, obj[0].customerLoan.tenureId, obj[0].customerLoan.id, obj[0].customerLoanEmploymentDetail.id, obj[0].contactNo);
                        let moreBasicDetail = new personalloanMoreBasicDetailResponse_1.PersonalLoanMoreBasicDetailResponse(obj[0].alternativeContactNo, obj[0].gender, obj[0].maritalStatusId, (_a = obj[0].customerLoanSpouses) === null || _a === void 0 ? void 0 : _a.name, (_b = obj[0].customerLoanSpouses) === null || _b === void 0 ? void 0 : _b.contactNo, obj[0].customerLoan.motherName, obj[0].customerLoan.fatherContactNo, (_c = obj[0].customerLoanSpouses) === null || _c === void 0 ? void 0 : _c.id, obj[0].customerLoan.fatherName, loanAmountTakenExisting, approxDate, approxCurrentEMI, bankId, topupAmount, obj[0].customerLoan.loanType);
                        let moreEmploymentDetail = new personalloanMoreEmploymentDetailResponse_1.PersonalLoanMoreEmploymentDetailResponse(obj[0].email, obj[0].customerLoanEmploymentDetail.designation, obj[0].customerLoanEmploymentDetail.companyTypeId, obj[0].customerLoanEmploymentDetail.currentCompanyExperience, obj[0].customerLoanEmploymentDetail.label, obj[0].customerLoanEmploymentDetail.addressLine1, obj[0].customerLoanEmploymentDetail.addressLine2, obj[0].customerLoanEmploymentDetail.pincode, obj[0].customerLoanEmploymentDetail.cityId, obj[0].customerLoanEmploymentDetail.city, obj[0].customerLoanEmploymentDetail.district, obj[0].customerLoanEmploymentDetail.state, obj[0].customerLoanEmploymentDetail.companyAddressId);
                        ...
                        let currentAddressDetail = obj[0].currentAddressDetail ? new personalloanCurrentAddressDetailResponse_1.PersonalloanCurrentAddressDetailResponse(obj[0].currentAddressDetail.label, obj[0].currentAddressDetail.addressLine1, obj[0].currentAddressDetail.addressLine2, obj[0].currentAddressDetail.pincode, obj[0].currentAddressDetail.cityId, obj[0].currentAddressDetail.addressTypeId, obj[0].currentAddressDetail.addressId, obj[0].currentAddressDetail.city, obj[0].currentAddressDetail.state, obj[0].currentAddressDetail.district) : null;
                        let loanDocuments = [];
                        let loanReference = [];
                        if (obj[0].customerLoanDocuments && obj[0].customerLoanDocuments.length > 0) {
                            for (let k = 0; k < obj[0].customerLoanDocuments.length; k++) {
                                let doc = new personalloanDocumentsResponse_1.PersonalLoanDocumentResponse(obj[0].customerLoanDocuments[k].id, obj[0].customerLoanDocuments[k].documentId, obj[0].customerLoanDocuments[k].documentUrl, obj[0].customerLoanDocuments[k].documentName, obj[0].customerLoanDocuments[k].isPdf, obj[0].customerLoanDocuments[k].serviceTypeDocumentId, obj[0].customerLoanDocuments[k].documentStatus);
...
const getCustomerPersonalById = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        logging_1.default.info(NAMESPACE, 'Get Customer Personal Loan By Customer Loan Id');
        ...
        if (validationResult && validationResult.statusCode == 200) {
            ...
            if (authorizationResult.statusCode == 200) {
                ...
                if (result && result.length > 0) {
                        ...
                        if (obj && obj.length > 0) {
                            for (let i = 0; i < obj.length; i++) {
                                for (let j = 0; j < obj[i].customerLoan.length; j++) {
                                    ...
                                    let currentAddressDetail = obj[i].customerLoan[j].currentAddressDetail ? new personalloanCurrentAddressDetailResponse_1.PersonalloanCurrentAddressDetailResponse(obj[i].customerLoan[j].currentAddressDetail.label, obj[i].customerLoan[j].currentAddressDetail.addressLine1, obj[i].customerLoan[j].currentAddressDetail.addressLine2, obj[i].customerLoan[j].currentAddressDetail.pincode, obj[i].customerLoan[j].currentAddressDetail.cityId, obj[i].customerLoan[j].currentAddressDetail.addressTypeId, obj[i].customerLoan[j].currentAddressDetail.addressId, obj[i].customerLoan[j].currentAddressDetail.city, obj[i].customerLoan[j].currentAddressDetail.state, obj[i].customerLoan[j].currentAddressDetail.district) : null;
                                    let loanDocuments = [];
                                    let loanReference = [];
                                    let loanStatus;
                                    if (obj[i].customerLoan[j].customerLoanDocuments && obj[i].customerLoan[j].customerLoanDocuments.length > 0) {
                                        for (let k = 0; k < obj[i].customerLoan[j].customerLoanDocuments.length; k++) {
                                            let doc = new personalloanDocumentsResponse_1.PersonalLoanDocumentResponse(obj[i].customerLoan[j].customerLoanDocuments[k].id, obj[i].customerLoan[j].customerLoanDocuments[k].documentId, obj[i].customerLoan[j].customerLoanDocuments[k].documentUrl, obj[i].customerLoan[j].customerLoanDocuments[k].documentName, obj[i].customerLoan[j].customerLoanDocuments[k].isPdf, obj[i].customerLoan[j].customerLoanDocuments[k].serviceTypeDocumentId, obj[i].customerLoan[j].customerLoanDocuments[k].documentStatus);
                                            loanDocuments.push(doc);
                                        }
                                    }
                    ...
                    let errorResult = new resulterror_1.ResultError(400, true, "personalLoan.getCustomerLoansByStatusId() Error", result, '');
                    next(errorResult);
                }
            }
            else {
        ...
        let errorResult = new resulterror_1.ResultError(500, true, 'personalLoan.getCustomerLoansByStatusId()', error, '');
        next(errorResult);
    }
});
const getOffer = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        if (validationResult && validationResult.statusCode == 200) {
            ...
            if (authorizationResult.statusCode == 200) {
                ...
                if (result && result.length > 0) {
                    ...
                    let errorResult = new resulterror_1.ResultError(400, true, "personalLoan.getOffer() Error", result, '');
                    next(errorResult);
                }
            }
            else {
        ...
        let errorResult = new resulterror_1.ResultError(500, true, 'personalLoan.getOffer() Exception', error, '');
        next(errorResult);
    }
});
const checkEligibility = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        logging_1.default.info(NAMESPACE, 'get Offer');
            ...
            if (authorizationResult.statusCode == 200) {
                ...
                if (result && result.length > 0) {
                    if (result[0] && result[0].length > 0) {
                        ...
                        let successResult = new resultsuccess_1.ResultSuccess(200, true, 'Get Generated Offer', offer, offer.length);
                        return res.status(200).send(successResult);
                    }
                    let successResult = new resultsuccess_1.ResultSuccess(200, true, 'Get Generated Offer', offer, offer.length);
                    return res.status(200).send(successResult);
                    ...
                    let errorResult = new resulterror_1.ResultError(400, true, "personalLoan.checkEligibility() Error", result, '');
                    next(errorResult);
                }
            }
            else {
...
const customerAcceptOffer = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        if (validationResult && validationResult.statusCode == 200) {
            ...
            if (authorizationResult.statusCode == 200) {
                ...
                if (result && result.affectedRows >= 0) {
                    ...
                    let errorResult = new resulterror_1.ResultError(400, true, "personalLoan.customerAcceptOffer() Error", result, '');
                    next(errorResult);
                }
            }
            else {
        ...
        let errorResult = new resulterror_1.ResultError(500, true, 'personalLoan.customerAcceptOffer() Exception', error, '');
        next(errorResult);
    }
});
const getCustomerLoanRejectionReason = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        logging_1.default.info(NAMESPACE, 'get Loan Rejection Reason');
        var requiredFields = ['customerLoanId'];
        var validationResult = apiHeader_1.default.validateRequiredFields(req, requiredFields);
        if (validationResult && validationResult.statusCode == 200) {
            let authorizationResult = yield apiHeader_1.default.validateAuthorization(req, res, next);
            if (authorizationResult.statusCode == 200) {
                ...
                if (result && result.length > 0) {
                    ...
                    let successResult = new resultsuccess_1.ResultSuccess(200, true, 'Get Loan Rejection Reason', result[0][0], result[0].length);
                    console.log(successResult);
                    return res.status(200).send(successResult);
                }
                else {
                    let errorResult = new resulterror_1.ResultError(400, true, "personalLoan.getCustomerLoanRejectionReason() Error", result, '');
                    next(errorResult);
                }
            }
            else {
        ...
        let errorResult = new resulterror_1.ResultError(500, true, 'personalLoan.getCustomerLoanRejectionReason() Exception', error, '');
        next(errorResult);
    }
});
const getCustomerLoanDetail = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        if (validationResult && validationResult.statusCode == 200) {
            ...
            if (authorizationResult.statusCode == 200) {
                ...
                let result = yield query(sql);
                if (result && result.length > 0) {
                    let successResult = new resultsuccess_1.ResultSuccess(200, true, 'Get Loan Detail', result[0], result[0].length);
                    return res.status(200).send(successResult);
                }
                else {
                    let errorResult = new resulterror_1.ResultError(400, true, "personalLoan.getCustomerLoanDetail() Error", result, '');
                    next(errorResult);
                }
            }
            else {
        ...
        let errorResult = new resulterror_1.ResultError(500, true, 'personalLoan.getCustomerLoanDetail() Exception', error, '');
        next(errorResult);
    }
});
...
const newToTransfer = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        if (validationResult && validationResult.statusCode == 200) {
            ...
            if (authorizationResult.statusCode == 200) {
                ...
                let customerLoanResult = yield query(customerLoanSql, req.body.customerLoanId);
                if (customerLoanResult && customerLoanResult.affectedRows >= 0) {
                    let successResult = new resultsuccess_1.ResultSuccess(200, true, 'Conver New To Transfer', customerLoanResult, 1);
                    return res.status(200).send(successResult);
                }
                else {
                    let errorResult = new resulterror_1.ResultError(400, true, "personalLoan.newToTransfer() Error", customerLoanResult, '');
                    next(errorResult);
                }
            }
            else {
        ...
        let errorResult = new resulterror_1.ResultError(500, true, 'personalLoan.newToTransfer() Exception', error, '');
        next(errorResult);
    }
});
exports.default = {
