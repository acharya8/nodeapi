...
const InsertUpdateBusinessLoanMoreBasicDetail = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        logging_1.default.info(NAMESPACE, 'Insert/Update Business Loan More Basic Detail');
        ...
        if (validationResult && validationResult.statusCode == 200) {
            ...
            if (authorizationResult.statusCode == 200) {
                ...
                if (result) {
                    if (result.length > 0 && result[0].length > 0) {
                        let successResult = new resultsuccess_1.ResultSuccess(200, true, 'Business Loan More Basic Detail Saved', result[0], 1);
                        console.log(successResult);
                        return res.status(200).send(successResult);
                    }
                    else {
                        let successResult = new resultsuccess_1.ResultSuccess(200, true, 'Business Loan More Basic Detail Saved', result, 1);
                        console.log(successResult);
                        return res.status(200).send(successResult);
                    }
                }
                else {
                    let errorResult = new resulterror_1.ResultError(400, true, "Business Loan More Basic Detail Not Saved", result, '');
                    next(errorResult);
                }
            }
            else {
        ...
        let errorResult = new resulterror_1.ResultError(500, true, 'businessLoan.InsertUpdateBusinessLoanMoreBasicDetail()', error, '');
        next(errorResult);
    }
});
const uploadBusinessLoanDocument = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        logging_1.default.info(NAMESPACE, 'Insert/Update Business Loan Documents Detail');
        ...
        let errorResult = new resulterror_1.ResultError(500, true, 'businessLoan.uploadBusinessLoanDocument()', error, '');
        next(errorResult);
    }
});
            ...
            if (authorizationResult.statusCode == 200) {
                ...
                if (result) {
                    if (result[0][0].message && result[0][0].message == "Data Not Available") {
                        ...
                        let basicDetail = new businessLoanBasicDetailResponse_1.BusinessLoanBasicDetailResponse(obj[0].fullName, obj[0].birthdate, obj[0].panCardNo, obj[0].customerLoan.employmentTypeId, obj[0].pincode, obj[0].customerLoan.loanAmount, obj[0].customerLoan.id, obj[0].customerloanbusinessdetails.businessAnnualSale, obj[0].customerloanbusinessdetails.businessExperienceId, obj[0].email, obj[0].gender, obj[0].maritalStatusId, obj[0].customerloancurrentresidentdetails.residentTypeId, obj[0].cityId, obj[0].customerloanbusinessdetails.companyTypeId, obj[0].customerloanbusinessdetails.businessNatureId, obj[0].customerloanbusinessdetails.industryTypeId, obj[0].customerloanbusinessdetails.businessAnnualProfitId, obj[0].customerloanbusinessdetails.primaryBankId, obj[0].addressId, obj[0].customerloanbusinessdetails.id, obj[0].customerloancurrentresidentdetails.id, obj[0].customerLoan.loanAgainstCollateralId, obj[0].customerloanbusinessdetails.currentlyPayEmi, null, null, loanAmountTakenExisting, approxDate, approxCurrentEMI, bankId, topupAmount, obj[0].customerLoan.loanType);
                        let moreBasicDetail = new businessLoanMoreBasicDetailResponse_1.BusinessLoanMoreBasicDetailResponse(obj[0].addressLine1, obj[0].addressLine2, obj[0].customerloanbusinessdetails.businessName, obj[0].customerloanbusinessdetails.businessGstNo, obj[0].contactNo);
                        ...
                        if (obj[0].customerLoanStatusHistory) {
                            ...
                            loanStatus = new loanStatusResponse_1.LoanStatusResponse(obj[0].customerLoanStatusHistory.id, obj[0].customerLoanStatusHistory.transactionDate, obj[0].customerLoanStatusHistory.loanStatus, obj[0].customerLoanStatusHistory.isDataEditable, result[6][0].transactionDate, obj[0].customerLoan.displayName, null);
                        }
                        let loanOffer = [];
                        ...
                        let response = new businessLoanResponse_1.BusinessLoanResponse(basicDetail, moreBasicDetail, loanCompleteHistory, loanStatus, loanDocuments2, loanOffer);
                        let successResult = new resultsuccess_1.ResultSuccess(200, true, 'Getting Business Loan Incomplete Data', [response], 1);
                        console.log(successResult);
                        return res.status(200).send(successResult);
                    }
                }
...
const getCustomerBusinessLoanById = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        logging_1.default.info(NAMESPACE, 'Get Incomplete Business Loan Detail');
        ...
        if (validationResult && validationResult.statusCode == 200) {
            ...
            if (authorizationResult.statusCode == 200) {
                ...
                if (result) {
                    ...
                    let errorResult = new resulterror_1.ResultError(400, true, "businessLoan.getCustomerBusinessLoanById() Error", result, '');
                    next(errorResult);
                }
            }
            else {
        ...
        let errorResult = new resulterror_1.ResultError(500, true, 'businessLoan.getCustomerBusinessLoanById()', error, '');
        next(errorResult);
    }
});
exports.default = {
