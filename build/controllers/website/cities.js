    ...
    try {
        ...
        if (result && result.length > 0) {
            if (result[0].length >= 0) {
                let successResult = new resultsuccess_1.ResultSuccess(200, true, 'Get City', result[0], result[0].length);
        ...
        let errorResult = new resulterror_1.ResultError(500, true, 'cities.getCities()', error, '');
        next(errorResult);
    }
});
