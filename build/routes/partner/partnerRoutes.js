...
const partners_1 = __importDefault(require("../../controllers/partner/partners"));
 ...
 */
// #endregion
router.post('/getNetworkandTeamPartnerListByRoleId', partners_1.default.getNetworkandTeamPartnerListByRoleId);
 ...
 */
// #endregion
router.post('/verifyPartner', partners_1.default.verifyPartner);
 ...
 */
// #endregion
router.post('/updatePartnerProfile', partners_1.default.updatePartnerProfile);
 ...
 */
// #endregion
router.post('/getCommisionListByPartnerId', partners_1.default.getCommisionListByPartnerId);
 ...
 */
// #endregion
router.post('/insertUpdatePartnerBankDetail', partners_1.default.insertUpdatePartnerBankDetail);
 ...
 */
// #endregion
router.post('/getBankDetailByPartnerId', partners_1.default.getBankDetailByPartnerId);
 ...
 */
// #endregion
router.post('/checkContactNoExistWithServiceId', partners_1.default.checkContactNoExistWithServiceId);
 ...
 */
// #endregion
router.post('/checkContactNoExistWithServiceIdFroOtherLoansAndServices', partners_1.default.checkContactNoExistWithServiceIdFroOtherLoansAndServices);
 ...
 */
// #endregion
router.post('/checkContactNoExistForCreditCard', partners_1.default.checkContactNoExistForCreditCard);
 ...
 */
// #endregion
router.post('/getNetworkandTeamPartnerListByParentPartnerId', partners_1.default.getNetworkandTeamPartnerListByParentPartnerId);
 ...
 */
// #endregion
router.post('/getPartnerGroupCustomers', partners_1.default.getPartnerGroupCustomers);
 ...
 */
// #endregion
router.post('/getNetworkandTeamPartnerHierarchyListByRoleId', partners_1.default.getNetworkandTeamPartnerHierarchyListByRoleId);
