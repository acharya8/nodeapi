...
const customers_1 = __importDefault(require("../../controllers/admin/customers"));
 ...
 */
// #endregion
router.post('/getCustomers', customers_1.default.getCustomers);
 ...
 */
// #endregion
router.post('/checkContactNoExist', customers_1.default.checkContactNoExist);
 ...
 */
// #endregion
router.post('/insertUpdateCustomer', customers_1.default.insertCustomer);
 ...
 */
// #endregion
router.post('/getCustomerById', customers_1.default.getCustomerById);
 ...
 */
// #endregion
router.post('/deleteCustomerById', customers_1.default.deleteCustomerById);
 ...
 */
// #endregion
router.post('/getState', customers_1.default.getStates);
 ...
 */
// #endregion
router.post('/getBecomePartnerRequest', customers_1.default.getBecomePartnerRequest);
 ...
 */
// #endregion
router.post('/assignRoleToCustomer', customers_1.default.assignRoleToCustomer);
 ...
 */
// #endregion
router.post('/becomePartner', customers_1.default.becomePartner);
 ...
 */
// #endregion
router.post('/temp_InsertUpdateCustomer', customers_1.default.temp_InsertUpdateCustomer);
