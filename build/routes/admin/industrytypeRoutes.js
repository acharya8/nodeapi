...
const industryTypes_1 = __importDefault(require("../../controllers/admin/industryTypes"));
 ...
 */
// #endregion
router.post('/getIndustryTypes', industryTypes_1.default.getIndustryTypes);
 ...
 */
// #endregion
router.post('/insertIndustryType', industryTypes_1.default.insertIndustryType);
 ...
 */
// #endregion
router.post('/updateIndustryType', industryTypes_1.default.updateIndustryType);
 ...
 */
// #endregion
router.post('/activeInactiveIndustryType', industryTypes_1.default.activeInactiveIndustryType);
